...
<span className="text-sm font-semibold text-on-surface tracking-tight leading-tight">Insights Copilot</span>
<span className="text-[10px] font-mono text-on-surface-variant tracking-wide">v2.4 Enterprise</span>
</div>
</div>
</div>
<div className="px-3">
<button className="w-full flex items-center justify-between px-3 py-2 rounded-xl bg-surface-container-low hover:bg-surface-container border border-card-border/60 text-on-surface-variant hover:text-on-surface transition-colors">
<div className="flex items-center gap-2 overflow-hidden">
<span className="material-symbols-outlined text-[18px] text-tertiary">layers</span>
<span className="text-xs font-medium text-on-surface truncate">Acme Mobile App</span>
</div>
...
<a className="flex items-center justify-between px-3 py-2 rounded-xl text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface text-xs font-medium transition-colors" data-path="reviews-inbox" href="#">
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-[19px]">inbox</span>
<span>Reviews Inbox</span>
</div>
<span className="px-1.5 py-0.2 rounded-full bg-secondary-container/60 text-secondary text-[10px] font-mono font-medium">24</span>
</a>
<a className="flex items-center gap-3 px-3 py-2 rounded-xl text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface text-xs font-medium transition-colors" data-path="analytics" href="#">
<span className="material-symbols-outlined text-[19px]">monitoring</span>
<span>Analytics</span>
</a>
<a className="flex items-center gap-3 px-3 py-2 rounded-xl text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface text-xs font-medium transition-colors" data-path="categories" href="#">
<span className="material-symbols-outlined text-[19px]">category</span>
<span>Categories</span>
</a>
<a className="flex items-center gap-3 px-3 py-2 rounded-xl text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface text-xs font-medium transition-colors" data-path="word-cloud" href="#">
...
<a className="flex items-center gap-3 px-3 py-2 rounded-xl text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface text-xs font-medium transition-colors" data-path="reporting" href="#">
<span className="material-symbols-outlined text-[19px]">description</span>
<span>Reporting</span>
</a>
<a className="flex items-center gap-3 px-3 py-2 rounded-xl text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface text-xs font-medium transition-colors" data-path="settings" href="#">
...
<div className="w-8 h-8 rounded-full bg-primary-container/40 border border-primary-container text-primary flex items-center justify-center font-medium text-xs">
<span className="material-symbols-outlined text-[18px]">person</span>
</div>
<span className="absolute bottom-0 right-0 w-2 h-2 rounded-full bg-emerald-accent ring-2 ring-surface-container-lowest"></span>
</div>
<div className="flex flex-col overflow-hidden">
<span className="text-xs font-medium text-on-surface truncate">Dev Lead</span>
<span className="text-[10px] font-mono text-emerald-accent truncate">Online</span>
</div>
</div>
<button className="text-on-surface-variant hover:text-on-surface p-1 rounded-lg hover:bg-surface-container transition-colors">
...
<span className="text-on-surface font-semibold">Ideation &amp; Roadmapping</span>
</div>
<div className="h-4 w-px bg-card-border"></div>
<div className="flex items-center gap-2 px-2.5 py-1 rounded-full bg-surface-container-low border border-card-border text-[11px] font-mono text-on-surface-variant">
<span className="w-1.5 h-1.5 rounded-full bg-tertiary animate-pulse"></span>
<span className="text-on-surface font-medium">Linear &amp; Jira Synced</span>
...
<button className="hidden xl:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-surface-container-low hover:bg-surface-container border border-card-border/80 text-on-surface text-xs font-medium transition-colors">
<span className="material-symbols-outlined text-[16px] text-on-surface-variant">ios_share</span>
<span>Export RFC Deck</span>
</button>
<button className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-primary-container hover:bg-indigo-500 text-white text-xs font-semibold shadow-md shadow-primary-container/25 transition-all">
<span className="material-symbols-outlined text-[17px]">magic_button</span>
<span>+ Propose AI Feature Spec</span>
</button>
<div className="h-4 w-px bg-card-border"></div>
<button aria-label="Notifications" className="p-2 text-on-surface-variant hover:text-on-surface relative rounded-xl hover:bg-surface-container transition-colors">
<span className="material-symbols-outlined text-[19px]">notifications</span>
<span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-tertiary ring-2 ring-surface-container-lowest"></span>
</button>
</div>
</header>
<!-- Main Body Container -->
