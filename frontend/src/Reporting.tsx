...
<a className="flex items-center gap-3 px-3 py-2 rounded-xl text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface text-xs font-medium transition-colors" data-path="ideation" href="#">
...
<span className="text-[10px] font-mono text-emerald-accent truncate">Online • Copilot Active</span>
</div>
</div>
...
<span className="text-on-surface font-semibold">Reporting &amp; Executive Exports</span>
</div>
...
<span className="w-1.5 h-1.5 rounded-full bg-tertiary animate-pulse"></span>
<span className="text-on-surface font-medium">Co-pilot Synthesis: Live</span>
